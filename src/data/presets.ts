...
export const presets: Record<BusinessType, string[]> = {
  gimnasio: ['navbar', 'hero', 'services', 'pricing', 'stats', 'testimonials', 'map', 'contact', 'footer', 'whatsapp-float'],
  restaurante: ['navbar', 'hero', 'services', 'gallery', 'testimonials', 'faq', 'map', 'contact', 'footer'],
  comercio: ['navbar', 'hero', 'product-showcase', 'services', 'filters', 'kpis', 'sales-chart', 'top-products', 'funnel', 'inventory', 'map', 'footer'],
  salud: ['navbar', 'hero', 'services', 'team', 'booking', 'testimonials', 'faq', 'map', 'contact', 'footer'],
  estetica: ['navbar', 'hero', 'services', 'gallery', 'booking', 'testimonials', 'map', 'contact', 'footer'],
